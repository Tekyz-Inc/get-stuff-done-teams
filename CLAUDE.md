...
Contract-driven development methodology for Claude Code. An npm package that provides 37 slash commands (34 GSD-T workflow + 3 utility), a CLI installer, templates, and documentation for reliable, parallelizable AI-assisted development.
