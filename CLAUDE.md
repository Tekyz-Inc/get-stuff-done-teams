...
Contract-driven development methodology for Claude Code. An npm package that provides 35 slash commands (32 GSD-T workflow + 3 utility), a CLI installer, templates, and documentation for reliable, parallelizable AI-assisted development.
