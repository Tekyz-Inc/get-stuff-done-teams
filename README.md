...
This installs 43 GSD-T commands + 4 utility commands (47 total) to `~/.claude/commands/` and the global CLAUDE.md to `~/.claude/CLAUDE.md`. Works on Windows, Mac, and Linux.
...
│   ├── gsd-t-*.md                     # 43 GSD-T workflow commands
